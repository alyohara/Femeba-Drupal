...
function abc_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id = NULL) {
...
// ### Slideshow ###
  ...
  $form['slideshow']['slideimage'] = array(
    '#markup' => t('<sup>To change the slide images, you can choose from predefined images in _custom/sliderimg folder of the theme or from any other folder or server, <b>Image URL</b> must be formated as "/themes/contrib/abc/_custom/sliderimg/IMAGE" or "//otherserver.com/IMAGE". The slides are language aware and <b>Slide URL</b> can point to Home (if left blank), internal pages ("/node/NODE_NUMBER"), or any page on Internet ("//www.website.com"). </sup>'),
  );
